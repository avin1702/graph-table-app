  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Select the first 5 rows by default
        ...
        <div className="w-full md:w-1/2 pl-0 md:pl-4">
          <div className="rounded-lg overflow-hidden shadow-lg">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={resetSelection} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Reset Selection</button>
            </div>
